...
```bash
cat 2023-04*creator*.csv 2023-05*creator*.csv 2023-06*creator*.csv | csvstack  > thunderbird-2023-04-01-2023-06-30-questions.csv
cat 2023-04*answers-for*.csv 2023-05*answers-for*.csv 2023-06*answers-for*.csv | csvstack  > thunderbird-2023-04-01-2023-06-30-answers.csv
```
